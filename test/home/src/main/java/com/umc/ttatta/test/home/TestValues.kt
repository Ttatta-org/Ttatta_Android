...
object TestValues {
    ...
    val TODAY: LocalDateTime = LocalDateTime.parse("2025-01-11T11:15:30.000000")
    const val CONTENT = "나는 말하는 감자다. 나는 말하는 감자다. 나는 말하는 감자다. 나는 말하는 감자다. 나는 말하는 감자다. 나는 말하는 감자다. "

...
class TestActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            HomeApp(viewModel = viewModel, navController = navController)
        }
        // ✅ 테스트
        prepareTest()
    }
...
//            }
            ...
            // ✅ **2.3. 기존 일기 조회 수정 (로그 추가)**
            val existingDiaries = diaryRepository.getDiaries(
                page = 1,
                date = null
            )
            ...
            // ✅ **2.4. 일기 불러오기 (로그 추가)**
            //val diaries = diaryRepository.getDiaries(page = 1, date = TestValues.TODAY.toLocalDate())
